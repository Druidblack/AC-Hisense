...
CONFIG_SCHEMA = BASE_CLIMATE_SCHEMA.extend({
    **BASE_CLIMATE_EXTRA,
    ...
    # Selects which Hisense Sleep program is used by the standard Sleep preset.
    # No entity category is assigned, so it appears with normal controls.
...
async def to_code(config):
    ...
    # Sleep program selector used by the standard Climate Sleep preset.
